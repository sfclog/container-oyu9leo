...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oyu9leo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oyu9leo.containers.anotherwebservice.com/
...
```
git clone git@github.com:sfclog/container-oyu9leo.git
cd container-oyu9leo
```
...
```
docker attach container-oyu9leo
```
